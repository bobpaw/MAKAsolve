...
void HYPRESolver::integrate(HYPRE_IJMatrix A, HYPRE_IJVector b,
														HYPRE_IJVector x) {
...
void HYPRESolver::solve(HYPRE_IJMatrix A, HYPRE_IJVector b, HYPRE_IJVector x,
												MPI_Comm& comm) {
